...
using Nucleotic.CalculationEngine.WebApi.Areas.HelpPage;
using Nucleotic.CalculationEngine.WebApi.Models.Postman;
...
namespace Nucleotic.CalculationEngine.WebApi.Controllers
{
  ...
  public class PostmanApiController : ApiController
  {
    ...
    {
      _requestNamingStyle = RequestNamingStyle.ActionName;
    }
    ...
    private PostmanCollectionGet PostmanCollectionForController()
    {
      ...
      {
        Id = Guid.NewGuid(),
        Name = "Nucleotic.CalculationEngine.WebApi",
        Description = "",
      ...
      foreach (var apiDescriptionsByControllerGroup in apiDescriptionsByController)
      {
        ...
        var postManFolder = new PostmanFolderGet
        {
          ...
          CollectionName = "Nucleotic.CalculationEngine.WebApi",
          Order = new Collection<Guid>()
        };
